...
// uses the schema constructor to create new schema
const Schema = mongoose.Schema;

// pass a javascript object to define how product should look like
const productSchema = new Schema({
    // use simple key value pairs with type
    // mongo.db is schemaless but mongoose gives you the flexibility to deviate from that
    title: {
        type: String,
        required: true
    },
    ...
    userId: {
        // add a special ref configuration to relate to the model
